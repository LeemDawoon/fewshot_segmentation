...
class Encoder(nn.Module):
    ...
    def __init__(self, in_channels=3, pretrained_path=None):
        ...
        self.l1 = self._make_layer(2, in_channels, 64)
        self.p1 = nn.MaxPool2d(kernel_size=3, stride=2, padding=1)
        self.l2 = self._make_layer(2, 64, 128)
        self.p2 = nn.MaxPool2d(kernel_size=3, stride=2, padding=1)
        self.l3 = self._make_layer(3, 128, 256)
        self.p3 = nn.MaxPool2d(kernel_size=3, stride=2, padding=1)
        self.l4 =self._make_layer(3, 256, 512)
        self.p4 =nn.MaxPool2d(kernel_size=3, stride=1, padding=1)
        self.l5 =self._make_layer(3, 512, 512, dilation=2, lastRelu=False)
